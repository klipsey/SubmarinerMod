...
namespace SubmarinerMod.Modules
{
    internal static class Tokens
    {
        ...
        public const string SubmarinerPressuredPrefix = "Pressured";
        ...
        public static string submarinerRegenBuff = KeywordText("N'kuhanna's Restoration", "Gain 10% increased health regen per stack.");
